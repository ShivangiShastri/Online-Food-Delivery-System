document.getElementById('contact-form').addEventListener('submit', function(event) {
  ...
  function submitForm(formData) {
    // Make an API request to the backend (API Gateway) for form submission
      fetch('https://7nxr01fod9.execute-api.us-east-2.amazonaws.com/dev/submit', { // URL that represents the backend API endpoint to which the form data is going to be sent
      method: 'POST',
      headers: {
